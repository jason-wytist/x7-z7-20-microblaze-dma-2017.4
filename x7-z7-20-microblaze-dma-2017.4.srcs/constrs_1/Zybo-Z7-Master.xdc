...
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { reset_rtl }]; #IO_L9P_T1_DQS_34 Sch=sw[3]
...
set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { o_cts }]; #IO_L19P_T3_35 Sch=je[4] 
